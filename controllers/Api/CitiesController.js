...
exports.paginate = async (req, res, next) => {
    try {
        ...
        const count = await conn.cities.findAll();
...
exports.getCitiesById = async (req, res, next) => {
    try {
        const result = await conn.cities.findOne({
...
exports.updateCities = async (req, res, next) => {
    try {
        const category = await conn.cities.findOne({
            where: {
                id: req.params.id,
            },
        });
        ...
        await conn.cities.update(req.body, {
            where: { id: req.params.id },
        });
